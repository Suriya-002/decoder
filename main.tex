...
at $p_g=5.4\times10^{-4}$. Points are offset horizontally so they do not
overlap; error bars are $95\%$ confidence intervals. The lower panel is the
residual on a magnified scale. The color code has six two-qubit layers per
...
its $95\%$ interval. Fig.~\ref{fig:recovery} shows the recovery and the
residuals. An independent seed gives $-0.010$, $0.245$, $0.488$, $0.763$, $1.000$.
